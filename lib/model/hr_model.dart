class AllFood {
  ...
  AllFood({this.allCategories, this.allPosts});
...
class AllPosts {
  ...
  static List<AllPosts> recipefood(List data) {
    return data.map((e) => AllPosts.fromJson(e)).toList();
  }
}
...
class AllCategories {
  ...
  static List<AllCategories> allitem(List data) {
    return data.map((e) => AllCategories.fromJson(e)).toList();
  }
}
